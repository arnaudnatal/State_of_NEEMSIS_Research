...
********** Import
import excel "Data\NEEMSIS_papers.xlsx", sheet("Papers") firstrow clear
drop if Title==""
drop Permanentlink
save"Stata_cmd\Papers_v0", replace
...
fre status
replace Year=$y if status==1
replace Year=$y if status==2
...
********** Journal details
merge m:1 Name using "Stata_cmd\journals"
drop _merge

*
save"Stata_cmd\Papers_v1", replace
****************************************
* END
...
****************************************
* Import + Lists for Project
****************************************

********** Import
import excel "Data\NEEMSIS_papers.xlsx", sheet("Projects") firstrow clear
drop if Title==""
...
********** Supp?
replace Suppcoauthors="0" if Suppcoauthors=="No"
replace Suppcoauthors="1" if Suppcoauthors=="Yes"
destring Suppcoauthors, replace
label values Suppcoauthors yesno

*
save"Stata_cmd\Projects_v1", replace
****************************************
* END
