...
********** Combine 2
count
graph combine top bot, col(1) title("Published research papers (N=`r(N)')", size(medium)) note("{it:Note:} *Green or gold open access. Papers cited `c' times (`cn')." "{it:Source:} A. Natal. Updated in September 2025.", size(vsmall)) name(pub, replace)
graph export "Beamer/INPUT/PP_global.pdf", as(pdf) replace
...
set graph on
count
graph combine top bot, col(1) title("Citations for published papers (N=`r(N)')", size(medium)) note("{it:Note:} For a total of `ttc' citations (`ttnc')." "{it:Source:} A. Natal. Updated in September 2025.", size(vsmall)) name(cite, replace)
graph export "Beamer/INPUT/PP_citations.pdf", as(pdf) replace
...
set graph on
graph combine top wpdate, col(1) title("WP (N=`N')", size(medium)) note("{it:Source:} A. Natal. Updated in September 2025.", size(vsmall)) name(wpglobal, replace)
graph export "Beamer/INPUT/PP_wp.pdf", as(pdf) replace
